...
function adicionarRegistro(novoRegistro) {
  ...
  celAcao.innerHTML =
    `<button onclick="editarRegistro(${novoRegistro.id})">Editar</button>` +
    `<button class="remover-btn" onclick="removerUltimoRegistro(event,${novoRegistro.id})">Remover Registro</button>`;
}
